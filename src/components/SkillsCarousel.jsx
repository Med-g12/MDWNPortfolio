...
const SkillsCarousel = React.forwardRef((props, ref) => {
    ...
    return (
        <section className="w-full overflow-hidden pb-8" aria-labelledby="skills-carousel-heading">
            <h2 id="skills-carousel-heading" className="sr-only">Technology Stack</h2>
            <div 
                ref={ref} 
                role="region"
            ...
            >
                <ul className="flex animate-marquee gap-10 md:gap-16 lg:gap-0 list-none p-0 m-0" aria-label="Skills Marquee">
