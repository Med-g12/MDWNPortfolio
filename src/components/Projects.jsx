								...
								>
									<div className="relative h-[35rem] overflow-hidden rounded-2xl border border-gray-200/70 bg-white/75 shadow-md backdrop-blur-sm dark:border-green-300/40 dark:bg-black/35 sm:h-[44rem] sm:shadow-lg">
										...
										<div className="relative z-10 flex h-full flex-col p-4 transition-opacity duration-300 group-hover:opacity-0 sm:p-7">
											...
											<div className="flex-1 space-y-3 text-gray-600 dark:text-gray-300 sm:space-y-5">
												<div>
													<p className="text-[11px] font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 sm:text-xs">
														Purpose
													</p>
												...
												<div>
													<span className="inline-block rounded-full bg-gray-100 px-2.5 py-1 text-[11px] font-medium text-gray-700 dark:bg-white/10 dark:text-gray-200 sm:px-3 sm:text-xs">
														{project.tech}
													</span>
												</div>
											</div>
